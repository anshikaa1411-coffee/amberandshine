...
- **Private Atelier Newsletter**: Minimalist email input with *"A little luxury, in your inbox"*.
...
```
hi/
├── index.html         # Main HTML5 page with Mia by Tanishq inspired editorial layout
├── styles.css         # Complete luxury design system & responsive styles
├── products.js        # 14KT/18KT Fine jewellery catalog & category data
├── cart.js            # Reactive cart, wishlist, coupon engine (SHINE20), pincode store
├── app.js             # UI view controller, video consultation modal, search, filters
